...
Appointment booking & number allocation

View lab test status & download reports

Access medical certificates

Supplier Portal

Drug supplier registration & profile management

Enter and manage drug details (name, type, stock availability)

Check and update orders from the medical centre

Public Services

Access to appointment availability

Digital communication with the centre
...
My Contribution: 60% of the system
