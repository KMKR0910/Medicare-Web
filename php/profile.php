...
<body>
    <div class="profile-container">
        ...
        <p><strong>Name:</strong> <?php echo htmlspecialchars($user['name']); ?></p> <!-- Adjust 'name' based on your column name -->
        <p><strong>Contact:</strong> <?php echo htmlspecialchars($user['contact']); ?></p> <!-- Adjust 'contact' based on your column name -->
